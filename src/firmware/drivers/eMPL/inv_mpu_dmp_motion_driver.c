...
int dmp_read_quat ( float * quat, unsigned char * more )
{
    ...
    quat[0] = ( float ) ( ( fifo_data[0] << 24 ) | ( fifo_data[1] << 16 ) | ( fifo_data[2] << 8 ) | fifo_data[3] );
    quat[1] = ( float ) ( ( fifo_data[4] << 24 ) | ( fifo_data[5] << 16 ) | ( fifo_data[6] << 8 ) | fifo_data[7] );
    quat[2] = ( float ) ( ( fifo_data[8] << 24 ) | ( fifo_data[9] << 16 ) | ( fifo_data[10] << 8 ) | fifo_data[11] );
    quat[3] = ( float ) ( ( fifo_data[12] << 24 ) | ( fifo_data[13] << 16 ) | ( fifo_data[14] << 8 ) | fifo_data[15] );
